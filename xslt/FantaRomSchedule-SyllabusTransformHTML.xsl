                ...
                <div id="main">    
                   <div id="heading"> 
                       <div id="courseInfo">
                        ...
                        <p><strong><a id="dateRef">Jump Down to the Current Day on the Schedule</a></strong></p>
                       ...
                       <div id="picture">
                           <img id="dragon" src="tolkienDragonKtrans.png" alt="Tolkien's artwork depicting a dragon arranged in a knot"/>
                       </div>
